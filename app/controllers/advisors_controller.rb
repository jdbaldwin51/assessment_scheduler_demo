class AdvisorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advisor.save
        format.html { redirect_to advisor_url(@advisor), notice: "Advisor was successfully created." }
  ...
  def update
    respond_to do |format|
      if @advisor.update(advisor_params)
        format.html { redirect_to advisor_url(@advisor), notice: "Advisor was successfully updated." }
