...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference("Advisor.count") do
      post advisors_url, params: { advisor: { email: @advisor.email, invitation_code: @advisor.invitation_code, name: @advisor.name } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { email: @advisor.email, invitation_code: @advisor.invitation_code, name: @advisor.name } }
